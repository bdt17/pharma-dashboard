...
class AddDeviseToUsers < ActiveRecord::Migration[8.1]
  def up
    change_table :users do |t|
      ...
      ## Trackable (uncomment if needed later)
      ...
      ## Confirmable (uncomment if needed later)
      ...
      ## Lockable (uncomment if needed later)
    ...
    # Add indexes only if columns don't exist or indexes aren't present
  ...
  def column_exists?(table, column)
    ActiveRecord::Base.connection.column_exists?(table.to_sym, column.to_sym)
  end
end
